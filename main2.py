...
from models.YourCNN import YourCNN #da chiedere a Filippo
...
def get_datasets(args):
    ...
    if args.dataset == 'idda':
        ...
        train_datasets = EMNIST(root='path/to/emnist', split='letters', train=True, download=True)
        test_datasets = EMNIST(root='path/to/emnist', split='letters', train=False, download=True)
