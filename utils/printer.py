...
df1 = pd.read_csv('accuracy_stndConfig_SPEC_True_ls_5.csv')
plt.plot(df1['x_round'], df1['y'], label='Spec ls 5')


df2 = pd.read_csv('accuracy_stndConfig_AttetntionModule_SPEC_True_ls_5.csv')
plt.plot(df2['x_round'], df2['y'], label='Attention + ls 5')
...
df4 = pd.read_csv('accuracy_stndConfig_NIID_base.csv')
plt.plot(df4['x_round'], df4['y'], label='standard')
